...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		...
		}
		{
			...
			_plugin_api.POST("/create_mcp_plugin", append(_createmcppluginMw(), coze.CreateMcpPlugin)...)
			_plugin_api.POST("/update_mcp_plugin", append(_updatemcppluginMw(), coze.UpdateMcpPlugin)...)
			_plugin_api.POST("/list_mcp_plugins", append(_listmcppluginsMw(), coze.ListMcpPlugins)...)
			_plugin_api.POST("/get_mcp_plugin", append(_getmcppluginMw(), coze.GetMcpPlugin)...)
			_plugin_api.POST("/delete_mcp_plugin", append(_deletemcppluginMw(), coze.DeleteMcpPlugin)...)
		}
		{
